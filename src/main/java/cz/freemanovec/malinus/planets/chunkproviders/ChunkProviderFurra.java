...
public class ChunkProviderFurra extends ChunkProviderSpace{
	...
	double[] field_147426_g, field_147427_d, field_147428_e, field_147425_f;
	public NoiseGeneratorOctaves noiseGen6;
	private NoiseGeneratorOctaves field_147431_j, field_147432_k, field_147429_l;
	...
	public void generateTerrain(int chunkX, int chunkZ, Block[] idArray, byte[] metaArray){
		Main.log.info("Generate on ChunkProvider bypassed :)");
	}
	...
	public void worldObjDataDump(World toDump, boolean attempToRegister){
		Main.log.error("--------BEGINNING OF WORLD DATA DUMP--------");
		Main.log.error("Save Handler -> " + toDump.getSaveHandler());
		Main.log.error("The Profiler -> " + toDump.theProfiler);
		Main.log.error("World Info -> " + toDump.getWorldInfo());
		Main.log.error("World Info - Seed -> " + toDump.getWorldInfo().getSeed());
		Main.log.error("World Info - Game Type -> " + toDump.getWorldInfo().getGameType());
		...
		Main.log.error("-----------END OF WORLD DATA DUMP-----------");
	}
	...
	public Chunk provideChunk(int p_73154_1_, int p_73154_2_)
    {
        ...
        this.biomesForGeneration = super.worldObj.getWorldChunkManager().loadBlockGeneratorData(this.biomesForGeneration, p_73154_1_ * 16, p_73154_2_ * 16, 16, 16);
	...
	public void func_147424_a(int p_147424_1_, int p_147424_2_, Block[] p_147424_3_)
    {
        ...
        WorldChunkManager par2 = par1.getWorldChunkManager();
        BiomeGenBase[] par_par1 = this.biomesForGeneration;
        int par_par2 = p_147424_1_ * 4 - 2;
        int par_par3 = p_147424_2_ * 4 - 2;
        if(par2==null)
        	Main.log.info("Terrain type: " + par1.getWorldInfo().getTerrainType());
        
        BiomeGenBase[] par3 = par2.getBiomesForGeneration(par_par1, par_par2, par_par3, 10, 10);
        //BiomeGenBase[] par3 = par2.getBiomesForGeneration(this.biomesForGeneration, p_147424_1_ * 4 - 2, p_147424_2_ * 4 - 2, 10, 10);
        this.biomesForGeneration = par3;
